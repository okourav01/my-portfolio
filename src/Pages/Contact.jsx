...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitUrl = 'https://formsubmit.co/okourav76@gmail.com';
      ...
      submitData.append('_subject', 'New Message from the Portfolio Website');
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Have a question? Send me a message, and I will reply to it shortly.
        </p>
      </div>
